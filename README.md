...
CalcGcd. Занятия по С#. Платформа DotNet Framework. Алгоритмы. Простой ввод/вывод. Консольное приложение.
...
Программа делает следующее:
  ...
  4. Если числа не равны нулю, двум временным переменным присваиваются их абсолютные величины (модули).
  5. В цикле с предусловием выполняется алгоритм Евклида:
      ...
      4.3. Если первое число больше чем второе, то из первого числа вычитается второе,
           в противном случае из второго - первое.   
  7. На экран выводятся введённые числа и их наибольший общий делитель.       
